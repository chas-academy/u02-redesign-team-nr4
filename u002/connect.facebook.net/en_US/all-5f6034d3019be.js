/*1666155791,,JIT Construction: v1006418595,en_US*/
...
try {
    ...
    i.src = 'https://www.facebook.com/platform/scribe_endpoint.php/?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script || "all.js") + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1006418595","namespace":"FB","message":"' + e.message + '"}}');
